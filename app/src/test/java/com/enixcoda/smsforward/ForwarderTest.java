...
public class ForwarderTest {
    ...
    @Test
    public void destinationLabelIsIncludedWhenProvided() {
        ArrayList<String> messages = Forwarder.buildSmsMessages("Alice", "Hello", false, "SIM 1 (Carrier) +1 555 0100");
        assertEquals(1, messages.size());
        assertEquals("From Alice\nVia SIM 1 (Carrier) +1 555 0100:\nHello", messages.get(0));
    }

    @Test
    public void nullOrEmptyDestinationLabelFallsBackToPlainPrefix() {
        assertEquals("From Alice:\nHello", Forwarder.buildSmsMessages("Alice", "Hello", false, null).get(0));
        assertEquals("From Alice:\nHello", Forwarder.buildSmsMessages("Alice", "Hello", false, "").get(0));
    }
